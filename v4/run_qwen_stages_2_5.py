#!/usr/bin/env python3
"""CHMC v4 Stages 2-5 for Qwen/Qwen2.5-0.5B — calibration, sparse comp, eff rank, shared basis."""
...
if len(valid_blocks) == 0:
    ...
    stage5_results = {
        ...
        "note": "Q and K projections have different output dimensions in this model architecture. Shared basis requires matching shapes.",
    }
else:
